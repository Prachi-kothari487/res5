...
// //   },
// //   withCredentials: false, // set to true only if you’re using cookies/sessions
// // });
...
// //     // ✅ Automatically detect FormData (for multer uploads)
// //     if (config.data instanceof FormData) {
// //       // ❗ Important: Let the browser set the correct `Content-Type` boundary
...
//     // ✅ Detect FormData for image upload (multer)
//     if (config.data instanceof FormData) {
